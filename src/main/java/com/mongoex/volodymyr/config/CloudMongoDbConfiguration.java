package com.mongoex.volodymyr.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.mongoex.volodymyr.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.mongoex.volodymyr.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.mongoex.volodymyr.config.dbmigrations");
